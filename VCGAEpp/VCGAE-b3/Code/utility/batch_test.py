...
cores = multiprocessing.cpu_count() // 2   #除以2,避免主机资源过度占用
...
def ranklist_by_heapq(user_pos_test, test_items, rating, Ks):
    ...
    item_score_total = heapq.nlargest(len(test_items), item_score, key=item_score.get)


    r = []
    # for i in K_max_item_score:    ...
    for i in item_score_total:
